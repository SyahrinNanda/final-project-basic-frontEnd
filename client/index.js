  ...
  try {
    ...
    */
    const book = {
      ...
      year: parseInt(event.target.elements.year.value),
...
function generateEditFormInput() {
  ...
  <input required type="hidden" id="id" name="id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500" value="${currentBook?.id}">
...
async function editBook(book) {
  try {
    ...
    */
    ...
    // if (bookId) {
    //   console.log("id book valid");
    // } else {
    //   throw new Error("id book not valid");
    // }
    if (response.ok) {
